...
public class LoginPage extends VBox {
    ...
    public LoginPage() {
        ...
        PrimaryField digitTest = new PrimaryField(PrimaryField.FieldVariant.ERROR, "Error");
        PrimaryField ErrorTest = new PrimaryField(PrimaryField.FieldVariant.NUMBER_ONLY, "0");
        
        VBox.setVgrow(emailField, Priority.ALWAYS);
        VBox.setVgrow(passwordField, Priority.ALWAYS);
        VBox.setVgrow(digitTest, Priority.ALWAYS);
        VBox.setVgrow(ErrorTest, Priority.ALWAYS);
        
        emailField.setMaxWidth(464);
        passwordField.setMaxWidth(464);
        digitTest.setMaxWidth(464);
        ErrorTest.setMaxWidth(464);
        ...
        getChildren().addAll(emailField, passwordField, digitTest, ErrorTest, loginButton, createAccountButton);
    }
}